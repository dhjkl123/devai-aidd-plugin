 ...
 *     the 7 published files (8 lines total). Both installer integrity-check
...
const filesToPublish = [
  ...
  { source: path.join(projectRoot, "dist", "devai-aidd-plugin.project.jsonc"), name: "devai-aidd-plugin.project.jsonc" },
